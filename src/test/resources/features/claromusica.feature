...
Funcionalidade: Testes exploratórios na aplicação
  ...
  Cenario: Realizar contratação de plano mensal
    ...
    E clico no botao "Iniciar ilimitado" "Plano mensal"


    Quando valido o texto "Claro música Ilimitado" "Plano mensal"
    E valido a imagem "Botão fechar" "Plano mensal"
    E valido o texto "Bem-vindo ao" "Plano mensal"
    E valido o texto ":l:" "Plano mensal"
    E valido o texto "ilimitado" "Plano mensal"
    E valido o texto "Entendido" "Plano mensal"
    E clico no botao "Entendido" "Plano mensal"
    Entao salvo o documento
